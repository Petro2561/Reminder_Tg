import enum
from sqlalchemy import Boolean, Column, Date, String, Time, func, Enum, ForeignKey
...
class Reminder(Base):
    ...
    def from_gpt(cls, from_gpt: dict, user: DBUser) -> Self:
        ...
        return cls(
            ...
            repeat_day_of_week=from_gpt.get("день_недели", None) if repeat_type == RepeatType.WEEKLY else None,
            user=user
        )