...
class Reminders(ModelView, model=Reminder):
    column_list = [Reminder.title, Reminder.date, Reminder.time, Reminder.user, Reminder.title, Reminder.repeat_day_of_week, Reminder.notified, Reminder.repeat_type]
